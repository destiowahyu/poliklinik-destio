...
<body>
    ...
    <div class="content" id="content">
        ...
        <div class="container">
            ...
            <div class="welcome">
                    Jadwal Periksa : <span><strong style="color: #42c3cf;"><?= htmlspecialchars($dokterName) ?>!</strong></span>
            </div>

            <button class="btn btn-primary mb-3 mt-4" data-bs-toggle="modal" data-bs-target="#addScheduleModal"><i class="bi bi-calendar-plus"></i> Tambah Jadwal</button>
